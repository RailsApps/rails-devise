...
To run the tests, you must set an environment variable @ENV["DOMAIN_NAME"]@, hardcode a value in the file *config/secrets.yml*, or change the @config.mailer_sender@ value in *config/initializers/devise.rb*.
